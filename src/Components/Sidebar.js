  ...
  <ul className="menu-slide">
    ...
    <li className="menu-item-has-children">
      ...
      <ul className="submenu">
        ...
        <li>
          <a href="http://wpkixx.com/html/socimo/development-elements.html" title>Elements</a>
        </li>
        <li>
          <a href="http://wpkixx.com/html/socimo/development-component.html" title>Components</a>
        </li>
      </ul>
    </li>
  </ul>
